...
│   ├── portfolio-health-check/         # 组合诊断       ← 新增
│   ├── suitability-report-generator/   # 投资文档       ← 新增
│   ├── financial-statement-analyzer/   # 财务深度分析   ← 新增
│   ├── event-driven-detector/          # 特殊情况       ← 新增
│   ├── quant-factor-screener/          # 多因子筛选     ← 新增
│   └── esg-screener/                   # ESG分析        ← 新增
...
│   ├── portfolio-health-check/         # 组合健康诊断   ← 新增
│   ├── suitability-report-generator/   # 适当性报告     ← 新增
│   ├── financial-statement-analyzer/   # 财务深度分析   ← 新增
│   ├── event-driven-detector/          # 事件驱动       ← 新增
│   ├── quant-factor-screener/          # 量化因子       ← 新增
│   └── esg-screener/                   # ESG筛选        ← 新增
├── README.md                           # 英文版本
...
- *"Review my portfolio for hidden risks and concentration issues"* ← 新增
- *"Generate a suitability report for this portfolio recommendation"* ← 新增
- *"Do a deep dive into Apple's financial statements"* ← 新增
- *"What merger arbitrage opportunities are available right now?"* ← 新增
- *"Screen stocks using a multi-factor model with value and quality"* ← 新增
- *"Find the best ESG-rated companies in the S&P 500"* ← 新增
